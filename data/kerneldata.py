...
class KERNELData(data.Dataset):
    ...
    def _scan(self):
        ...
        for vid_hr_name, vid_lr_name, vid_kernel_name in zip(vid_hr_names, vid_lr_names, vid_kernel_names):
            ...
            #hr_dir_names = hr_dir_names[self.n_seq//2: self.n_seq//2+len(vid_kernel_names)]
            #lr_dir_names = lr_dir_names[self.n_seq//2: self.n_seq//2+len(vid_kernel_names)]
        ...
        print(len(names_hr), len(names_lr), len(names_kernel))
